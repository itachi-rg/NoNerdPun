...
public class MapsActivity extends FragmentActivity {
    ...
    private void setUpMap() {
        LatLng center = new LatLng(12.9539974,77.6309395); //bengaluru
...
//                Toast.makeText(MapsActivity.this, latLng.toString(), Toast.LENGTH_LONG).show();
    ...
    public void setLocation(LatLng latLng) {
        new getJsonFromUrl(MapsActivity.this,"http://" + MainActivity.hostIp + ":8080/addEventLocation?eventName=" +
                CreateEvent.eventName+"&latitude="+latLng.latitude+"&longitude="+latLng.longitude).execute();
